              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-sm font-medium">{tool.estimatedTime}</div>
                    <div className="text-xs text-gray-500">Temps estimé</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <CreditCard className="h-6 w-6 mx-auto mb-2 text-gray-600" />
                    <div className="text-sm font-medium">{tool.price} crédits</div>
                    <div className="text-xs text-gray-500">Coût</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <Download className="h-6 w-6 mx-auto mb-2 text-gray-600" />
                    <div className="text-sm font-medium">{tool.outputType}</div>
                    <div className="text-xs text-gray-500">Format de sortie</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
