    ...
    <>
      ...
      {!isNavbarOpen && (
        <button
          ...
          className={cn("fixed bottom-6 z-50 w-14 h-14 bg-gradient-primary text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 md:hidden", burgerPosition)}
        >
          <Menu size={24} />
        </button>
      )}
