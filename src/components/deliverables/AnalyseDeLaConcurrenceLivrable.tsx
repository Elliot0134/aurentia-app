...
const AnalyseDeLaConcurrenceLivrable: React.FC = () => {
  ...
  const concurrenceData = currentProject?.concurrence?.[0] as AnalyseDeLaConcurrenceData | undefined;
    ...
    <>
      ...
      {isPopupOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={handlePopupClose}>
          ...
          >
            <h2 className="text-xl font-bold mb-2">Analyse de la Concurrence</h2>
